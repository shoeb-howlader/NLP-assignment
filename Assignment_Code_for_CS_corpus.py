...
c=1
print("100 most frequent words excluding  puntuations: ",file=open("A_output_for_cs.txt","w"))
print("word  -->   frequency",file=open("A_output_for_cs.txt","a"))
top_100=fdist.most_common(100)
for i,j in top_100:
    print(f"{c}. {i} --> {j}",file=open("A_output_for_cs.txt","a"))
    c+=1
...
count=0
print("Words with rank >100 (1000 words per line ):",file=open("B_output_for_cs.txt","w"))
print("Wrod--> frequency:     ",file=open("B_output_for_cs.txt","a"))
for x,y in rank_greater_than_100:
    print(f' {x}--> {y}',end =" ",file=open("B_output_for_cs.txt","a"))
    count+=1
    if count==1000:
        print("\n",file=open("B_output_for_cs.txt","a"))
        count=0
...
print('frequency of frequencies:    \n',file=open("C_output_for_cs.txt","w"))
for k in range(1,101):
    print(f'C{k} --> {frequency_of_frequency[k]}',file=open("C_output_for_cs.txt","a"))
...
print(f'The corpus has {types} types',file=open("D_output_for_cs.txt","w"))
print(f'The corpus has {tokens} tokens',file=open("D_output_for_cs.txt","a"))
print(f'the type/token ratio for the corpus is {types/tokens}',file=open("D_output_for_cs.txt","a"))
...
c=1
print("100 most frequent words excluding stop words and puntuations: ",file=open("E_output_for_cs.txt","w"))
print("word  -->   frequency",file=open("E_output_for_cs.txt","a"))
for i,j in top_100_without_sw:
    print(f"{c}. {i} --> {j}",file=open("E_output_for_cs.txt","a"))
    c+=1
...
print("Most frequent word pairs: ",file=open("F_output_for_cs.txt","w"))
print("Word pair --> frequency",file=open("F_output_for_cs.txt","a"))
c=1
for x,y in bigram_top_100:
    print(f"{c}. {x} --> {y}",file=open("F_output_for_cs.txt","a"))
    c+=1
...
print("strong collocations of two words using mutual information:",file=open("G_output_for_cs.txt","w"))
mutual_information = biagram_collocation.nbest(BigramAssocMeasures.pmi, 20)
for z in mutual_information:
    print(z,file=open("G_output_for_cs.txt","a"))
#strong collocation using  chi-square    
print("\n\nstrong collocations of two words using chi-square: ",file=open("G_output_for_cs.txt","a"))
chi_square= biagram_collocation.nbest(BigramAssocMeasures.chi_sq, 20)
for v in chi_square:
    print(v,file=open("G_output_for_cs.txt","a"))

#strong collocation using  likelihood ratio
print("\n\n strong collocations of two words using likelihood ratio:",file=open("G_output_for_cs.txt","a"))
likelihood_ratio= biagram_collocation.nbest(BigramAssocMeasures.likelihood_ratio, 20)
for n in likelihood_ratio:
    print(n,file=open("G_output_for_cs.txt","a"))

#strong collocation using  phi- square measure
print("\n\n strong collocations of two words using phi- square:",file=open("G_output_for_cs.txt","a"))
